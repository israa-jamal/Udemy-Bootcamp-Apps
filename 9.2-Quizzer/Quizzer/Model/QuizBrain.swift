...
//  Quizzer
//
//  Created by Esraa Gamal on 4/23/20.
...
struct QuizBrain{
    ...
    mutating  func nextQuestion(){
        //get the next question as long as it didn't reach the end of the questions' array
        if questionNumber < quiz.count-1 {
            questionNumber += 1
        }else {
            questionNumber = 0
            score = 0
            //when it reach the end of the array it resets everything
        }
    }
